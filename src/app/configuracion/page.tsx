    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2 rounded-2xl border border-border bg-surface-card p-4">
        ...
        <p className="text-sm text-text-secondary">
          Todos tus datos viven solo en este navegador. Exporta un respaldo
          periódicamente para no perder tu información si cambias de
          dispositivo o borras el caché.
        </p>
        <div className="mt-2">
          <ExportImportBar />
        </div>
